        ...
        <div class="content">
            ...
            <div class="w">
                ...
                <div class="formulaire">
                    ...
                    <form action="{{ url('modifProfil') }}/{{ $profils->id }} " method="POST"
                        ...
                        <div>
                            ...
                            <select required name="service">
                                <option value="No-Service">Choisissez un service</option>
                        ...
                        <input class="button" type="submit" value="Modifier le Profil">
                    </form>
                </div>
            </div>
        @endsection
